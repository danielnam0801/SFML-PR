...
void MenuScene::Init()
{
	...
	m_butonExit.setTexture(ResMgr::GetInst()->GetTexture("Exit"));
	...
	m_butonExit.setPosition(WindowMgr::GetInst()->GetWindow().getSize().x / 2
		- m_butonExit.getGlobalBounds().width / 2
		, WindowMgr::GetInst()->GetWindow().getSize().y / 2
		+ m_button2.getGlobalBounds().height / 2  + m_butonExit.getGlobalBounds().height);
...
void MenuScene::Render()
{
	...
	WindowMgr::GetInst()->GetWindow().draw(m_butonExit);
